...
3. Are there differences in the development of Parkinson's disease like behaviors between epoxomicin and PSI?
...
Our hypotheses are all non-directional due to the type of experimental study we are conducting. we predict there will be differences in the onset of Parkinson's disease like behaviors in PSI treatment versus the control, as well as a difference in epoxomicin and the control. Epoxomicin degrades the pathways inhibiting proteasome activity, thus a potentially more rapid onset of Parkinson's disease. PSI has a similar effect, but it is snythetic while epoxomicin is naturally occuring. 
...
https://doi.org/10.1016/S0165-0270(03)00192-4